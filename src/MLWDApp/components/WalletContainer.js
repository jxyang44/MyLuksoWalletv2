        ...
        <div
          ...
          style={{ backgroundImage: `url(${containerTexture})`, backgroundColor:walletMetadata?.vaultColor}}>
              ...
              <div //right buckle
                ...
                <div className="flex flex-col justify-center border-2 p-2 shadow-black shadow-lg border-slate-800 xl:w-[200%] w-[400%] rounded-l-xl h-full opacity-0 hover:opacity-100 

    ...
    <div className="flex w-full justify-center items-center mx-4 my-10">
      <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
        ...
        <div className="grid sm:grid-cols-2 grid-cols-2 w-full mt-10">
          <div className={`rounded-tl-2xl ${adjectiveStyles}`}>
            Secure
          </div>
          <div className={`sm:rounded-tr-2xl ${adjectiveStyles}`}>
            Vaulted
          </div>
          <div className={`sm:rounded-bl-2xl ${adjectiveStyles}`}>
            User-Friendly
          </div>
          <div className={`rounded-br-2xl ${adjectiveStyles}`}>
            Organized
          </div>
        </div>
      </div>

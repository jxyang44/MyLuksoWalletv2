...
const WhatisMyLuksoWallet = () => {
  ...
  return (
    <div className="flex flex-row justify-between h-[calc(100vmin-100px)] w-full relative xl:px-32 px-8 metal-bg" id="whatismyluksowallet">
      ...
      <div className="flex flex-col justify-center gap-2 w-7/12 xl:ml-24 ml-12">
        <div className="xl:text-3xl text-2xl font-semibold text-sky-500 text-center">What is MyLuksoWallet</div>
        <div className="xl:text-xl text-xl xl:mt-2 text-center">
          <div className="xl:text-5xl text-2xl mb-2">A front-end tool to creatively manage and showcase your digital assets</div>
          {learnMore ? (
            <div className="relative xl:text-base md:text-sm my-4 mx-2 rounded-lg p-4 pt-6 border-2 border-slate-300 text-sky-500 bg-slate-800 bg-opacity-90">
              <p>
                ...
                exchange, fund an account to pay gas fees (pending implementation), and manage cryptographic private keys, so that your transition into Web3 is smooth and
                seamless.
              </p>
              <br></br>
              <p>
              ...
              <br></br>
              <p>
                MyLuksoWallet aims to be an all-in-one service for your core Lukso digital asset needs. We are still a new project so we are very excited
                to implement more functionality as the Lukso ecosystem grows! At this point, we welcome any feedback so please reach out to us if you have any questions or suggestions.
              </p>
            ...
            <>
              ...
              <button
                className="mt-10 bg-slate-800 rounded-lg p-4 border-2 bg-opacity-90 border-slate-300 text-sky-500 xl:text-2xl text-base font-semibold hover:text-slate-700 hover:bg-slate-300 -z-8"

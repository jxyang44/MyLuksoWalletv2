...
import aboutLukso from "../assets/Home/aboutlukso.jpg";
const information = {
  aboutLukso: {
    title: "About Lukso",
    quote:
  ...
  aboutLSPs: {
    ...
    source: "https://lukso.network/faq",
    image:
      "https://docs.lukso.tech/assets/images/lsp-roadmap-e4e9af566a233b9acb4122136baf073a.jpg",
  },
  aboutUPs: {
    ...
    source: "https://lukso.network/faq",
    image:
      "https://docs.lukso.tech/assets/images/standard-detection-dafe387cab476e81d7a9858e19b9c88a.jpeg",
  },
  aboutAssets: {
    ...
    source: "https://lukso.network/faq",
    image:
      "https://docs.lukso.tech/assets/images/lsp4-digital-asset-metadata-diagram-c8e6b8df1fe281e29fbaad86c21526fe.png",
  },
};
...
const AboutLukso = () => {
  return (
    <div
      className="bg-slate-800 bg-fixed pb-32 bg-blend-multiply"
      style={{ backgroundImage: `url(${aboutLukso})` }}
    >
      <Banner
        ...
        buttonFunc={() =>
          window.open(
            "https://lukso.network/hackathon?utm_source=docs&utm_medium=docs&utm_campaign=banner"
          )
        }
      />

      <div className="flex flex-col items-center text-white">
        <div className=" my-10 flex flex-col gap-4 border-y border-y-gray-500 py-10 text-center">
          <p>
            - Below are some of the most frequently asked questions about Lukso.
            -
          </p>
          <p>
            - If you want to learn more, feel free to check out the resources at
            the bottom of the page. -
          </p>
          <p>- All quotes and images are sourced from Lukso's websites. -</p>
        </div>
        <div className="my-12 flex flex-col gap-64">
          <QuoteBox

  ...
  return (
    <div>
      <Banner
        ...
        subtitle={
          "Follow the instructions below to get started! Use the buttons as you work your way through the steps."
        }
        buttonText={""}
      />
      ...
      <div className="flex flex-col ml-20">
        <StepLeft
          ...
          text={[
            "The Universal Profile (UP) Browser Extension is an add-on that functions similarly to MetaMask.",
            "Use it to interact with any Lukso DApp!",
          ]}
        ...
        <StepRight
          ...
          text={[
            "For the hackathon, we recommend you create a Universal Profile using the extension.",
        ...
        <StepLeft
          ...
          text={[
            '"Connect Profile" to begin using MyLuksoWallet with the UP Browser Extension!',

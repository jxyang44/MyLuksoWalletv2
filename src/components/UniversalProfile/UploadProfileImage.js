  ...
  return (
    <div>
      <label htmlFor={id}>
         ...
         {!image.preview && (currentImage ? <img src={currentImage || defaultImage} className="rounded-full  cursor-pointer" alt="Profile Image" /> :
        ...
        {image.preview &&
         <img src={image.preview} className="rounded-full  cursor-pointer" alt="Profile Image" />
        }

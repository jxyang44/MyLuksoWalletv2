...
const activeLink =
  "flex items-center tracking-tighter gap-2 pl-3 py-3 rounded-lg text-white text-lg ml-2 mr-4 bg-gradient-to-br from-slate-900 to-slate-700";
const inactiveLink =
  "flex items-center tracking-tight gap-2 pl-3 py-1 rounded-lg text-md text-slate-300 mr-4 hover:bg-slate-900 ml-2";
    ...
    <div className="h-screen sticky top-0 md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10 bg-gradient-to-l from-slate-800 via-slate-600 to-slate-500 rounded-b-md rounded-t-sm">
      <div className="flex justify-between items-center ml-2 mt-4">
        <Logo
          ...
          customProps={"border-2 border-l-0 rounded-l-sm rounded-r-md border-blue-500 py-2"}
        />
        <button
          type="button"

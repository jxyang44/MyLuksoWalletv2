      ...
      <div
        ...
        <div className="flex justify-between flex-col w-full h-full">
          <div className="flex justify-between items-start text-lg text-neutral-100 mix-blend-lighten">
            ...
            <div
              className={
                `relative w-3/12 aspect-square flex justify-center items-center rounded-full` +
                borderSpin +
                borderSpinOuter
              }>
              <div
                className={
                  `w-full relative p-4 aspect-square rounded-full flex justify-center items-center` +
                  borderSpin +
                  borderSpinInner
                }>
                {assetMetadata.icon.length > 0 && (
                  <div className="relative before:content-'' before:absolute before:backdrop-opacity-0 saturate-200 backdrop-saturate-0">
                    <img src={assetMetadata.icon[0].url.replace("ipfs://", IPFS_GATEWAY)}></img>
                  </div>
                )}
              </div>
            </div>

    ...
    return (
        <div className='flex flex-col items-center gap-8 m-20'>
            ...
            <div className="text-green-500">   
                Please connect a Universal Profile to view your assets.
            </div>
            <Button_Shadow buttonText={"Instructions"} buttonFunc={()=> navigate("../getstarted")} buttonColor={"bg-slate-500"} buttonTextColor ={"text-black"} />  
        </div>
    )
}

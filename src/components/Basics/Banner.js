    ...
    <div className={`flex justify-between items-center flex-row h-36 p-8 mb-10 bg-gradient-to-r ${colorFrom}`}>
      <div className="flex items-center gap-4">
        ...
        <div className="ml-28 flex flex-col text-left text-white">
          <h3 className="w-fit text-4xl tracking-tight font-extrabold font-secondary text-transparent bg-clip-text bg-gradient-to-l pr-40 from-white to-pink-100">
            {title}
          </h3>
          <p className="w-fit text-xl tracking-wide font-semibold font-secondary whitespace-pre-line text-transparent bg-clip-text bg-gradient-to-l pr-40 from-teal-100 to-teal-300">
            {subtitle}
          </p>
        </div>
      </div>

...
const inputStyle =
  "shadow appearance-none border rounded w-full text-md py-1 px-2 m text-black leading-tight focus:outline-none focus:shadow-outline";
        ...
        <div className="w-full flex flex-col justify-start px-3 ">
          {inputLabel1 && (
            <>
              ...
              <input className={inputStyle} type="text" value={inputValue1} placeholder={"N/A"} readOnly={!enabled1} />
            </>
          )}
          {inputLabel2 && (
            <>
              <div className="mt-1 block text-slate-300 text-sm font-bold text-left">{inputLabel2}</div>
              <input className={inputStyle} type="text" value={inputValue2} placeholder={"N/A"} readOnly={!enabled2} />
            </>
          )}
        </div>
      </div>
